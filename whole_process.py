...
import models.model_baseline as model_baseline
import models.logic_inference as logic_inference
import models.logic_program as logic_program
import models.self_refinement as self_refinement
...
def parse_args():
    ...
    parser.add_argument('--dataset_list', type=str, default="ProntoQA ProofWriter FOLIO LogicalDeduction AR-LSAT")
...
if __name__ == "__main__":
    ...
    if framework_to_use == "OpenAI":
        ...
        llm_model = HuggingFaceModel(model_id=model_name, stop_words = args.stop_words, max_new_tokens=args.max_new_tokens, is_AWQ=args.is_AWQ, timeout_time=args.timeout_time, batch_size=args.batch_size)

    else:
        llm_model = LLMClass()

    for dataset in args.dataset_list.split(' '):
